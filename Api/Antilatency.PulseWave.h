...
namespace Antilatency {
	namespace PulseWave {
		...
		Antilatency::InterfaceContract::ExceptionCode setPulseWave(Antilatency::PulseWave::Description pulseWave, Antilatency::InterfaceContract::LongBool& result) {
		...
		*/
		struct IPulseWaveReceiver : Antilatency::InterfaceContract::IInterface {
			...
			Antilatency::InterfaceContract::ExceptionCode setPulseWave(Antilatency::PulseWave::Description pulseWave, Antilatency::InterfaceContract::LongBool& result) {
				return (reinterpret_cast<VMT*>(this->_object))->setPulseWave(pulseWave, result);
			}
		};
	} //namespace PulseWave
} //namespace Antilatency
		...
		namespace Details {
			...
			public:
				virtual Antilatency::InterfaceContract::ExceptionCode ANTILATENCY_INTERFACE_CALL setPulseWave(Antilatency::PulseWave::Description pulseWave, Antilatency::InterfaceContract::LongBool& result) {
					auto exceptionCode_ = this->_object->setPulseWave(pulseWave, result);
