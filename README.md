...
Git command to clone this subset: `git clone --branch subset-932bca9305d8e24f76ad95dc43df6b65b2db4d95 --single-branch https://github.com/AntilatencySDK/Release_4.5.0.git AntilatencySDK`
